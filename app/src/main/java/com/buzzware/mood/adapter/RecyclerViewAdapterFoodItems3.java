...
import com.buzzware.mood.databinding.LayoutItemsFoodItems3Binding;
...
public class RecyclerViewAdapterFoodItems3 extends RecyclerView.Adapter<RecyclerViewAdapterFoodItems3.ViewHolder>  {
    ...
    public RecyclerViewAdapterFoodItems3(Context mContext, List<String> list) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutItemsFoodItems3Binding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.binding.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EventBus.getDefault().post(new ShiftToFoodItemDetailFrag());
//
...
//                ((Activity) mContext).overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        LayoutItemsFoodItems3Binding binding;


        public ViewHolder(@NonNull LayoutItemsFoodItems3Binding binding) {
