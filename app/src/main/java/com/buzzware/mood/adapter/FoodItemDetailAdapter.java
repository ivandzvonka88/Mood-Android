...
import com.buzzware.mood.databinding.ItemDesignFoodItemDetailBinding;
...
public class FoodItemDetailAdapter extends RecyclerView.Adapter<FoodItemDetailAdapter.ViewHolder>  {
    ...
    public FoodItemDetailAdapter(Context mContext, List<String> list) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(ItemDesignFoodItemDetailBinding.inflate(LayoutInflater.from(parent.getContext()),
                parent, false));
    }
...
//        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        ItemDesignFoodItemDetailBinding binding;


        public ViewHolder(@NonNull ItemDesignFoodItemDetailBinding binding) {
