...
public class RecyclerViewAdapterFoodItems2 extends RecyclerView.Adapter<RecyclerViewAdapterFoodItems2.ViewHolder>  {
    ...
    public RecyclerViewAdapterFoodItems2(Context mContext, List<String> list) {
        this.list = list;
